...
@Epic("Тесты UI")
@Feature("Направления")
public class Access_1207Test extends BaseTest {
    ...
    public void Access_1207() throws IOException, SQLException, InterruptedException {
        ...
        WaitElement(consultationUn.TrueConsul);
    }
}
